...
from eval.perceptiontest.inference.ddp import *
...
def eval_model(args):
    ...
    dataset = EvalDatasetPerceptionTest(args.question_dir, args.video_folder, image_processor, video_processor)
