...
OUTPUT_DIR_PATH=results/videogpt_plus_finetune_wo_caption-version2

CUDA_VISIBLE_DEVICES=6 torchrun --nproc-per-node 1 --master_port=20058 videogpt_plus/train/train.py \
